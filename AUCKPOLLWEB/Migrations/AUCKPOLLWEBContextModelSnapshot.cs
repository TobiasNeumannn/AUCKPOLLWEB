...
namespace AUCKPOLLWEB.Migrations
{
    ...
    partial class AUCKPOLLWEBContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AUCKPOLLWEB.Models.regions", b =>
                {
                    ...
                    b.Property<int?>("airQualitysampleID")
                        .HasColumnType("int");

                    b.Property<int?>("estuaryQualitysampleID")
                        .HasColumnType("int");

                    b.Property<int?>("gWaterQualitysampleID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("estuaryQualitysampleID");

                    b.HasIndex("gWaterQualitysampleID");
            ...
            modelBuilder.Entity("AUCKPOLLWEB.Models.regions", b =>
                {
                    b.HasOne("AUCKPOLLWEB.Models.airQuality", null)
                        .WithMany("regionID")
                        .HasForeignKey("airQualitysampleID");

                    b.HasOne("AUCKPOLLWEB.Models.estuaryQuality", null)
                        .WithMany("regionID")
                        .HasForeignKey("estuaryQualitysampleID");

                    b.HasOne("AUCKPOLLWEB.Models.gWaterQuality", null)
                        .WithMany("regionID")
                        .HasForeignKey("gWaterQualitysampleID");
                });
